...
from .voxel_spatial_pruning import apply_voxel_spatial_pruning_to_memory, build_voxel_spatial_pruning_mask
...
__all__ = [
    ...
    "prune_rgbd_features",
    "apply_voxel_spatial_pruning_to_memory",
    "build_voxel_spatial_pruning_mask",
